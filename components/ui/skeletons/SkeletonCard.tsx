export default function SkeletonCard() {
  return (
    <div className="bg-background-card border border-border-default rounded-lg p-6 animate-pulse">
      <div className="flex justify-between items-start mb-4">
        <div className="space-y-2">
          <div className="h-5 w-24 bg-background-hover rounded" />
          <div className="h-4 w-32 bg-background-hover rounded" />
        </div>
        <div className="h-6 w-16 bg-background-hover rounded-full" />
      </div>
      ...
      <div className="flex justify-between items-center pt-4 mt-4 border-t border-border-default">
        ...
        <div className="h-8 w-20 bg-background-hover rounded" />
      </div>
    </div>
  );
}